...
#deploy with /home/*/.local/bin/pyinstaller --noconsole --onefile --clean PokerModel.py
#deploy with C:\Users\*\AppData\Local\Programs\Python\Python37\Scripts\pyinstaller.exe --noconsole --onefile --clean PokerView.py
#deploy with C:\Users\*\AppData\Local\Programs\Python\Python37\Scripts\pyinstaller.exe --noconsole --onefile --clean PokerModel.py
